...
extern zip_int32_t          VARARGS68K _main_zip_archive_set_tempdir(struct ZipIFace *, zip_t * za, const char * tempdir);
...
extern zip_int64_t          VARARGS68K _main_zip_dir_add(struct ZipIFace *, zip_t * za, const char * name, zip_flags_t flags);
...
extern zip_int64_t          VARARGS68K _main_zip_file_add(struct ZipIFace *, zip_t * za, const char * name, zip_source_t * source, zip_flags_t flags);
...
extern const char *         VARARGS68K _main_zip_file_get_comment(struct ZipIFace *, zip_t * za, zip_uint64_t idx, zip_uint32_t * lenp, zip_flags_t flags);
...
extern zip_int32_t          VARARGS68K _main_zip_file_rename(struct ZipIFace *, zip_t * za, zip_uint64_t idx, const char * name, zip_flags_t flags);
...
extern zip_int32_t          VARARGS68K _main_zip_file_set_comment(struct ZipIFace *, zip_t * za, zip_uint64_t idx, const char * comment, zip_uint16_t len, zip_flags_t flags);
...
extern const char *         VARARGS68K _main_zip_file_strerror(struct ZipIFace *, zip_file_t * zf);
extern zip_file_t *         VARARGS68K _main_zip_fopen(struct ZipIFace *, zip_t * za, const char * fname, zip_flags_t flags);
extern zip_file_t *         VARARGS68K _main_zip_fopen_encrypted(struct ZipIFace *, zip_t * za, const char * fname, zip_flags_t flags, const char * password);
extern zip_file_t *         VARARGS68K _main_zip_fopen_index(struct ZipIFace *, zip_t * za, zip_uint64_t index, zip_flags_t flags);
extern zip_file_t *         VARARGS68K _main_zip_fopen_index_encrypted(struct ZipIFace *, zip_t * za, zip_uint64_t index, zip_flags_t flags, const char * password);
extern zip_int64_t          VARARGS68K _main_zip_fread(struct ZipIFace *, zip_file_t * zf, APTR outbuf, zip_uint64_t toread);
extern const char *         VARARGS68K _main_zip_get_archive_comment(struct ZipIFace *, zip_t * za, zip_int32_t * lenp, zip_flags_t flags);
extern zip_int32_t          VARARGS68K _main_zip_get_archive_flag(struct ZipIFace *, zip_t * za, zip_uint32_t flag, zip_flags_t flags);
extern const char *         VARARGS68K _main_zip_get_name(struct ZipIFace *, zip_t * za, zip_uint64_t idx, zip_flags_t flags);
extern zip_int64_t          VARARGS68K _main_zip_get_num_entries(struct ZipIFace *, zip_t * za, zip_flags_t flags);
extern zip_int64_t          VARARGS68K _main_zip_name_locate(struct ZipIFace *, zip_t * za, const char * fname, zip_flags_t flags);
extern zip_t *              VARARGS68K _main_zip_open(struct ZipIFace *, const char * fn, zip_int32_t _flags, zip_int32_t * zep);
extern zip_int32_t          VARARGS68K _main_zip_set_archive_comment(struct ZipIFace *, zip_t * za, const char * comment, zip_uint16_t len);
extern zip_int32_t          VARARGS68K _main_zip_set_archive_flag(struct ZipIFace *, zip_t * za, zip_uint32_t flag, zip_int32_t value);
extern zip_int32_t          VARARGS68K _main_zip_set_default_password(struct ZipIFace *, zip_t * za, const char * passwd);
...
extern zip_source_t *       VARARGS68K _main_zip_source_file(struct ZipIFace *, zip_t * za, const char * fname, zip_uint64_t start, zip_int64_t len);
...
extern zip_int32_t          VARARGS68K _main_zip_stat(struct ZipIFace *, zip_t * za, const char * fname, zip_flags_t flags, zip_stat_t * st);
...
extern const char *         VARARGS68K _main_zip_strerror(struct ZipIFace *, zip_t * za);
...
extern zip_error_t *        VARARGS68K _main_zip_file_get_error(struct ZipIFace *, zip_file_t * zf);
extern int                  VARARGS68K _main_zip_file_set_mtime(struct ZipIFace *, zip_t * za, zip_uint64_t idx, time_t mtime, zip_flags_t flags);
extern zip_int8_t           VARARGS68K _main_zip_fseek(struct ZipIFace *, zip_file_t * zf, zip_int64_t offset, int whence);
extern zip_int64_t          VARARGS68K _main_zip_ftell(struct ZipIFace *, zip_file_t * zf);
extern int                  VARARGS68K _main_zip_source_begin_write(struct ZipIFace *, zip_source_t * zs);
...
extern int                  VARARGS68K _main_zip_source_close(struct ZipIFace *, zip_source_t * zs);
extern int                  VARARGS68K _main_zip_source_commit_write(struct ZipIFace *, zip_source_t * zs);
extern zip_error_t *        VARARGS68K _main_zip_source_error(struct ZipIFace *, zip_source_t * zs);
...
extern int                  VARARGS68K _main_zip_source_is_deleted(struct ZipIFace *, zip_source_t * zs);
extern void                 VARARGS68K _main_zip_source_keep(struct ZipIFace *, zip_source_t * zs);
extern int                  VARARGS68K _main_zip_source_open(struct ZipIFace *, zip_source_t * zs);
extern zip_int64_t          VARARGS68K _main_zip_source_read(struct ZipIFace *, zip_source_t * zs, void * data, zip_uint64_t len);
extern void                 VARARGS68K _main_zip_source_rollback_write(struct ZipIFace *, zip_source_t * zs);
extern int                  VARARGS68K _main_zip_source_seek(struct ZipIFace *, zip_source_t * zs, zip_int64_t offset, int whence);
...
extern int                  VARARGS68K _main_zip_source_seek_write(struct ZipIFace *, zip_source_t * zs, zip_int64_t offset, int whence);
extern int                  VARARGS68K _main_zip_source_stat(struct ZipIFace *, zip_source_t * zs, zip_stat_t * zstat);
extern zip_int64_t          VARARGS68K _main_zip_source_tell(struct ZipIFace *, zip_source_t * zs);
extern zip_int64_t          VARARGS68K _main_zip_source_tell_write(struct ZipIFace *, zip_source_t * zs);
extern zip_int64_t          VARARGS68K _main_zip_source_write(struct ZipIFace *, zip_source_t * zs, const void * data, zip_uint64_t len);
