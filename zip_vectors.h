...
extern void                 VARARGS68K _main_Expunge(struct ZipIFace *);
extern struct ZipIFace *    VARARGS68K _main_Clone(struct ZipIFace *);
...
extern int                  VARARGS68K _main_zip_compression_method_supported(struct ZipIFace *, zip_int32_t method, int compress);
extern int                  VARARGS68K _main_zip_encryption_method_supported(struct ZipIFace *, zip_uint16_t method, int encode);
