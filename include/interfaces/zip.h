...
struct ZipIFace
{
	...
	zip_int32_t APICALL (*zip_archive_set_tempdir)(struct ZipIFace *Self, zip_t * za, const char * tempdir);
	...
	zip_int64_t APICALL (*zip_dir_add)(struct ZipIFace *Self, zip_t * za, const char * name, zip_flags_t flags);
	...
	zip_int64_t APICALL (*zip_file_add)(struct ZipIFace *Self, zip_t * za, const char * name, zip_source_t * source, zip_flags_t flags);
	...
	const char * APICALL (*zip_file_get_comment)(struct ZipIFace *Self, zip_t * za, zip_uint64_t idx, zip_uint32_t * lenp, zip_flags_t flags);
	...
	zip_int32_t APICALL (*zip_file_rename)(struct ZipIFace *Self, zip_t * za, zip_uint64_t idx, const char * name, zip_flags_t flags);
	...
	zip_int32_t APICALL (*zip_file_set_comment)(struct ZipIFace *Self, zip_t * za, zip_uint64_t idx, const char * comment, zip_uint16_t len, zip_flags_t flags);
	...
	const char * APICALL (*zip_file_strerror)(struct ZipIFace *Self, zip_file_t * zf);
	zip_file_t * APICALL (*zip_fopen)(struct ZipIFace *Self, zip_t * za, const char * fname, zip_flags_t flags);
	zip_file_t * APICALL (*zip_fopen_encrypted)(struct ZipIFace *Self, zip_t * za, const char * fname, zip_flags_t flags, const char * password);
	zip_file_t * APICALL (*zip_fopen_index)(struct ZipIFace *Self, zip_t * za, zip_uint64_t index, zip_flags_t flags);
	zip_file_t * APICALL (*zip_fopen_index_encrypted)(struct ZipIFace *Self, zip_t * za, zip_uint64_t index, zip_flags_t flags, const char * password);
	zip_int64_t APICALL (*zip_fread)(struct ZipIFace *Self, zip_file_t * zf, APTR outbuf, zip_uint64_t toread);
	const char * APICALL (*zip_get_archive_comment)(struct ZipIFace *Self, zip_t * za, zip_int32_t * lenp, zip_flags_t flags);
	zip_int32_t APICALL (*zip_get_archive_flag)(struct ZipIFace *Self, zip_t * za, zip_uint32_t flag, zip_flags_t flags);
	const char * APICALL (*zip_get_name)(struct ZipIFace *Self, zip_t * za, zip_uint64_t idx, zip_flags_t flags);
	zip_int64_t APICALL (*zip_get_num_entries)(struct ZipIFace *Self, zip_t * za, zip_flags_t flags);
	zip_int64_t APICALL (*zip_name_locate)(struct ZipIFace *Self, zip_t * za, const char * fname, zip_flags_t flags);
	zip_t * APICALL (*zip_open)(struct ZipIFace *Self, const char * fn, zip_int32_t _flags, zip_int32_t * zep);
	zip_int32_t APICALL (*zip_set_archive_comment)(struct ZipIFace *Self, zip_t * za, const char * comment, zip_uint16_t len);
	zip_int32_t APICALL (*zip_set_archive_flag)(struct ZipIFace *Self, zip_t * za, zip_uint32_t flag, zip_int32_t value);
	zip_int32_t APICALL (*zip_set_default_password)(struct ZipIFace *Self, zip_t * za, const char * passwd);
	...
	zip_source_t * APICALL (*zip_source_file)(struct ZipIFace *Self, zip_t * za, const char * fname, zip_uint64_t start, zip_int64_t len);
	...
	zip_int32_t APICALL (*zip_stat)(struct ZipIFace *Self, zip_t * za, const char * fname, zip_flags_t flags, zip_stat_t * st);
	...
	const char * APICALL (*zip_strerror)(struct ZipIFace *Self, zip_t * za);
