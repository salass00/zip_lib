...
#define zip_compression_method_supported(method, compress) IZip->zip_compression_method_supported((method), (compress))
#define zip_encryption_method_supported(method, encode) IZip->zip_encryption_method_supported((method), (encode))
