...
#define zip_file_get_error(zf) IZip->zip_file_get_error((zf))
#define zip_file_set_mtime(za, idx, mtime, flags) IZip->zip_file_set_mtime((za), (idx), (mtime), (flags))
#define zip_fseek(zf, offset, whence) IZip->zip_fseek((zf), (offset), (whence))
#define zip_ftell(zf) IZip->zip_ftell((zf))
#define zip_source_begin_write(zs) IZip->zip_source_begin_write((zs))
#define zip_source_buffer_create(data, len, freep, error) IZip->zip_source_buffer_create((data), (len), (freep), (error))
#define zip_source_close(zs) IZip->zip_source_close((zs))
#define zip_source_commit_write(zs) IZip->zip_source_commit_write((zs))
#define zip_source_error(zs) IZip->zip_source_error((zs))
...
#define zip_source_is_deleted(zs) IZip->zip_source_is_deleted((zs))
#define zip_source_keep(zs) IZip->zip_source_keep((zs))
#define zip_source_open(zs) IZip->zip_source_open((zs))
#define zip_source_read(zs, data, len) IZip->zip_source_read((zs), (data), (len))
#define zip_source_rollback_write(zs) IZip->zip_source_rollback_write((zs))
#define zip_source_seek(zs, offset, whence) IZip->zip_source_seek((zs), (offset), (whence))
...
#define zip_source_seek_write(zs, offset, whence) IZip->zip_source_seek_write((zs), (offset), (whence))
#define zip_source_stat(zs, zstat) IZip->zip_source_stat((zs), (zstat))
#define zip_source_tell(zs) IZip->zip_source_tell((zs))
#define zip_source_tell_write(zs) IZip->zip_source_tell_write((zs))
#define zip_source_write(zs, data, len) IZip->zip_source_write((zs), (data), (len))
